#' @title Spherical to Cylindrical Coordinate Converter
#' @description
#' Converts spherical (rho,theta,phi) coordinates to (r,theta,z) cylindrical coordinates
...
sphericaltocylindrical <- function (rho,theta,phi){
  ...
  # Calculates the values of r and z; stores for later assignment
  r <- rho*sin(phi)
  z <- rho*cos(phi)
  # Assigns the values of (r,theta,z) to the vector 'cylindrical' for reporting
