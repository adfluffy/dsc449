#' @title Rectangular to Spherical Coordinate Converter
#' @description
#' Converts rectangular (x,y,z) coordinates to (rho,theta,phi) spherical coordinates
#' and returns coordinates as a vector
#' @param x x value for the point of interest
#' @param y y value for the point of interest
#' @param z z value for the point of interest
#' @export
#' @return spherical
#' @examples \dontrun{
...
rectangulartospherical <- function (x,y,z){
  ...
  # Calls the magnitude function to calculate the scalar value of spherical vector rho
  rho <- magnitude(x,y,z)
  # Calls the thetacalc function to calculate the angle (in radians) of spherical theta
  theta <- thetacalc(x,y)
  # Calls the phicalc function to calculate the angle (in radians) of spherical phi
  phi <- phicalc(z,rho)
  # Assigns the values of rho, theta, and phi to the vector 'spherical' for reporting
