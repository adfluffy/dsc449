#' @title Rectangular to Cylindrical Coordinate Converter
#' @description
#' Converts rectangular (x,y,z) coordinates to (r,theta,z) cylindrical coordinates
...
rectangulartocylindrical <- function (x,y,z){
  ...
  # call the magnitude function to determine the value of r
  r <- magnitude(x,y)
  # call the thetacalc function to determine the angle of theta
  theta <- thetacalc(x,y)
  # Assign r, theta, and z values to a the vector 'cylindrical'
  cylindrical <- c(r,theta,z)
